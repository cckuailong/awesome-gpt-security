...
* [Ziran](https://github.com/taoq-ai/ziran) - Open-source security testing framework for AI agents that discovers dangerous tool chain compositions via graph analysis, detects execution-level side effects, and runs multi-phase trust exploitation campaigns.
