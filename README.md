...
* [LuaN1aoAgent](https://github.com/SanMuzZzZz/LuaN1aoAgent) - LuaN1aoAgent is a fully autonomous AI penetration testing agent driven by graph-based cognitive reasoning.
...
* [EXORR Prompt Fuzzer](https://github.com/exorrtech/exorr-prompt-fuzzer) - Automated LLM prompt injection and jailbreak testing for red teams with 19 built-in payloads across 5 attack categories, heuristic response classification, and multi-format reporting.
* [EXORR Secret Scanner](https://github.com/exorrtech/exorr-secret-scanner) - Detect leaked secrets in Git repositories with 16 regex patterns, intelligent false-positive detection, and zero-dependency Python CLI.
