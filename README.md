...
* [x64dbg MCP Server](https://github.com/bromoket/x64dbg_mcp) - MCP server connecting LLMs to x64dbg for AI-driven Windows debugging and reverse engineering with 152 tools.
